...
### Exhibit 1 -- August 2010 Preliminary Report on Operations
  ...
  *Total: chips*                       *\$ 25,070,000*          *\$
                                                            22,824,000*

  Variable Supplies & Tools             \$ 12,507,000      \$ 11,305,000

  *Materials Subtotal*                 *\$ 37,577,000*          *\$
                                                            34,129,000*
...
### Exhibit 2-- Per-Unit Costs for iPhone 4
  ...
  ------------------------------------------------------------------------------
   **[Per-Unit Costs for iPhone                           
         4]{.underline}**                                 
  ------------------------------ ------------------------ ----------------------
       **[ ]{.underline}**        [Budgeted]{.underline}   [Actual]{.underline}
...
### Exhibit 3 -- Contribution Margin & Break-Even Point
  ...
  **[Contribution Margin &                           
  ...
  Point]{.underline}**                               
  ------------------------- ------------------------ -----------------------
                             [Budgeted]{.underline}   [Actual]{.underline}
  ...
  Contribution Margin per           \$ 4.14                  \$ 6.63
  Unit                                               
...
### Exhibit 4 -- Production Costs Based on 180k Production
  ...
  *Materials Subtotal*            *\$ 33,820,200*        *\$32,999,400*
  ...
  Labor: Assembly and               \$ 2,359,800          \$ 3,092,000
  Packaging                                           
